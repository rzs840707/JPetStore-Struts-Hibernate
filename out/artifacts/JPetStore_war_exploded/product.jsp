        ...
        function getItem(productid) {
            $.post("getItemByProductId" ,{"product.productid": productid}, function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    $(theA).find('img').attr('src',"image/"+imgLink);//image/EST-2.jpg
                    $(theA).find('img').attr("alt",name);
                    $(theA).find('img').attr("title",name);
...
<div class="w" style="margin-top: 120px;">
    ...
    <div class="flex-row">
        <div id="product-name">
       <s:iterator value="#request.product" var="o">

            <%--<a onclick="getItem('<%=product.getProductid()%>');focusThisA(this);">--%>
                <a onclick="getItem('<s:property value="#o.productid"/>');focusThisA(this);">
