...
<form action="user_register" method="post" class="form-register" >
    <div id="first-step">
        <P><s:text name="Username"></s:text><span class="warningMsg" id="user_msg"> </span></P>
        <input name="user.userid" type="text" id="name" onblur="checkName();"><br/>
        <P><s:text name="Password"></s:text><span class="warningMsg"> </span></P><input name="user.password" type="password" repeat="0"><br/>
        <P><s:text name="Repeat Password"></s:text><span class="warningMsg" id="password_msg"> </span></P><input name="password" type="password" repeat="1"><br/>
    ...
    <div id="second-step">
        <P><s:text name="Phone Number"></s:text><span class="warningMsg" id="phone_msg"> </span></P><input name="user.phone" id="phone" type="text" onblur="chkPhone()"><br/>

        <P><s:text name="E-mail"></s:text><span class="warningMsg" id="email_msg"> </span></P><input name="user.email" id="email" type="text" onblur="checkEmail()"><br/>

        <table style="width: 100%;" id="names">
            <tbody>
            <tr>
                <td><P><s:text name="Firstname"></s:text></P><br><input name="user.firstname" type="text"><br/></td>
                <td style="width: 9px;"></td>
                <td><P><s:text name="Lastname"></s:text></P><br><input name="user.lastname" type="text"><br/></td>
            </tr>
            </tbody>
        </table>


        <p><s:text name="Address"></s:text></p><input name="user.address" type="text"><br/>
        <P><s:text name="Zipcode"></s:text><span class="warningMsg"> </span></P><input name="user.zip" type="text"><br/>

        <input type="submit" value="<s:text name="Creat My Account"></s:text>" style="color: red;"><br/>
    </div>
