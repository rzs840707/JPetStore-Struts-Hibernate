    ...
    <div class="w">
        <div id="bg">
            <div class="login-form">
                <form action="user_login" method="post" style="">
                    <table cellspacing="0" class="t_table" style="">
                        ...
                        <tr>
                            ...
                            <td><input name="user.password" type="password" class="fixedWidthInput" ></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style=""><input id="vr" name="chknumber" class="fixedWidthInput" type="text" ></td>
                        </tr>
                        <tr>
                            <td><a href="userRegister.jsp"><s:text name="register"></s:text></a></td>
                            <td><input id="submit" type="submit"  value="<s:text name='signin'/>"
                                       class="fixedWidthInput"></td>
                        </tr>

                        <tr>
                            <td></td>
                            <td><s:fielderror name="chknumberError" fieldName="chknumberError" cssStyle="color: #761c19"></s:fielderror></td>
                        </tr>
                        </tbody>
                    </table>
                    <br>
                ...
                <br/>
                <a href="selectLang?local=zh_CN">中文</a>
                <a href="selectLang?local=en_US">English</a>
            </div>
            <script>
                function showLogin() {
